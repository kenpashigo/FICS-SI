      ...
      $link = DBConnect();
        ...
        if(isset($_POST['enviar']) && $_POST['enviar'] == "send"){
          ...
          if(empty($materia)){
            ...
            echo '<div id="alert-container"><img src="./ico/warning.png" alt="hora-do-post" width="45px" height="45px" height="auto" style="margin-right: 15px" /><p class="alert">É óbrigatório o link do arquivo a ser anexado, se não houver link digite "#"</p></div>';
