...
<div id="abso">
	...
	<div id="hidden-menu">
		<ul>
			...
			<li><a href="?pagina=publicar">POSTS</a></li>
		</ul>
	</div>
		...
		<div id="footer-content">
			<div id="links-uteis">
				...
				<div class="coluna">
					...
					<li><a href="#" target="_blank">Calendário</a></li>
			...
			<div id="low">
				<div id="register">
					<p>© 2016-2016 EnDivs Design | Kenpashi & Sufuria | <a href="./paginas/pcontrole.php"><span class="destaque">Versão 0.1 Λ</span></a>
